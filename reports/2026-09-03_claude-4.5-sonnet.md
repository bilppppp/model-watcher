...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | Claude 4.5 Sonnet | = No meaningful advantage | No |
| Planner | claude-3-7-sonnet | Claude 4.5 Sonnet | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | Claude 4.5 Sonnet | ? Insufficient evidence | No |
| Reasoner | o3-mini | Claude 4.5 Sonnet | ? Insufficient evidence | No |
| Analyst / Researcher | claude-3-7-sonnet | Claude 4.5 Sonnet | ? Insufficient evidence | No |
| Agent / Computer-use | claude-3-7-sonnet | Claude 4.5 Sonnet | = No meaningful advantage | No |
| Multimodal | gemini-2.5-pro | Claude 4.5 Sonnet | ? Insufficient evidence | No |
