...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | GPT 4.1 mini | ↘ Probably worse | No |
| Planner | claude-3-7-sonnet | GPT 4.1 mini | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | GPT 4.1 mini | ? Insufficient evidence | No |
| Reasoner | o3-mini | GPT 4.1 mini | ? Insufficient evidence | No |
| Analyst / Researcher | claude-3-7-sonnet | GPT 4.1 mini | ? Insufficient evidence | No |
| Agent / Computer-use | claude-3-7-sonnet | GPT 4.1 mini | ? Insufficient evidence | No |
| Multimodal | gemini-2.5-pro | GPT 4.1 mini | ? Insufficient evidence | No |
...
- **Coder / Builder (claude-3-7-sonnet)**: Challenger shows no meaningful capability edge over claude-3-7-sonnet (delta: -35.6% resolved).
...
- **Source:** SWE-bench | **Benchmark:** SWE-bench Verified (verified-v1)
  - **Score:** Challenger: 39.6% resolved vs Incumbent: 75.2% resolved
