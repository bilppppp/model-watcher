...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | qwen3.8-max | = No meaningful advantage | No |
| Planner | claude-3-7-sonnet | qwen3.8-max | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | qwen3.8-max | ? Insufficient evidence | No |
| Reasoner | o3-mini | qwen3.8-max | ↗ Probably better | No |
| Analyst / Researcher | claude-3-7-sonnet | qwen3.8-max | = No meaningful advantage | No |
| Agent / Computer-use | claude-3-7-sonnet | qwen3.8-max | = No meaningful advantage | No |
| Multimodal | gemini-2.5-pro | qwen3.8-max | ? Insufficient evidence | No |
...
- **Reasoner (o3-mini)**: Challenger achieved strong score (88.21%), but incumbent baseline score is unverified on same benchmark.
