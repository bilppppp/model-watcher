...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | Qwen2.5 (7B + 72B) | ↘ Probably worse | No |
| Planner | claude-3-7-sonnet | Qwen2.5 (7B + 72B) | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | Qwen2.5 (7B + 72B) | ? Insufficient evidence | No |
| Reasoner | o3-mini | Qwen2.5 (7B + 72B) | ? Insufficient evidence | No |
| Analyst / Researcher | claude-3-7-sonnet | Qwen2.5 (7B + 72B) | ? Insufficient evidence | No |
| Agent / Computer-use | claude-3-7-sonnet | Qwen2.5 (7B + 72B) | ? Insufficient evidence | No |
| Multimodal | gemini-2.5-pro | Qwen2.5 (7B + 72B) | ? Insufficient evidence | No |
...
- **Coder / Builder (claude-3-7-sonnet)**: Challenger shows no meaningful capability edge over claude-3-7-sonnet (delta: -42.4% resolved).
...
- **Source:** SWE-bench | **Benchmark:** SWE-bench Verified (verified-v1)
  - **Score:** Challenger: 32.8% resolved vs Incumbent: 75.2% resolved
  - **Harness:** SWE-Fixer
  - **URL:** https://www.swebench.com
  - **Confidence:** 75%
  - **Uncertainty:** Different harness: challenger on SWE-Fixer, incumbent on TRAE
