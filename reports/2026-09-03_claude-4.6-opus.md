...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | Claude 4.6 Opus | = No meaningful advantage | No |
| Planner | claude-3-7-sonnet | Claude 4.6 Opus | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | Claude 4.6 Opus | ? Insufficient evidence | No |
| Reasoner | o3-mini | Claude 4.6 Opus | ? Insufficient evidence | No |
| Analyst / Researcher | claude-3-7-sonnet | Claude 4.6 Opus | ? Insufficient evidence | No |
| Agent / Computer-use | claude-3-7-sonnet | Claude 4.6 Opus | = No meaningful advantage | No |
| Multimodal | gemini-2.5-pro | Claude 4.6 Opus | ? Insufficient evidence | No |
...
- **Source:** SWE-bench | **Benchmark:** SWE-bench Verified (verified-v1)
  - **Score:** Challenger: 75.6% resolved vs Incumbent: 75.2% resolved
