...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | Qwen2.5 Coder 32B Instruct | ↘ Probably worse | No |
| Planner | claude-3-7-sonnet | Qwen2.5 Coder 32B Instruct | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | Qwen2.5 Coder 32B Instruct | ? Insufficient evidence | No |
| Reasoner | o3-mini | Qwen2.5 Coder 32B Instruct | ? Insufficient evidence | No |
| Analyst / Researcher | claude-3-7-sonnet | Qwen2.5 Coder 32B Instruct | ? Insufficient evidence | No |
| Agent / Computer-use | claude-3-7-sonnet | Qwen2.5 Coder 32B Instruct | ? Insufficient evidence | No |
| Multimodal | gemini-2.5-pro | Qwen2.5 Coder 32B Instruct | ? Insufficient evidence | No |
...
- **Coder / Builder (claude-3-7-sonnet)**: Challenger shows no meaningful capability edge over claude-3-7-sonnet (delta: -28.2% resolved).
...
- **Source:** SWE-bench | **Benchmark:** SWE-bench Verified (verified-v1)
  - **Score:** Challenger: 47.0% resolved vs Incumbent: 75.2% resolved
  - **Harness:** Skywork-SWE-32B
  - **URL:** https://www.swebench.com
  - **Confidence:** 75%
  - **Uncertainty:** Different harness: challenger on Skywork-SWE-32B, incumbent on TRAE
