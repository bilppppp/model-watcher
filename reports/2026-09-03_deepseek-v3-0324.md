...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | DeepSeek V3 0324 | ↘ Probably worse | No |
| Planner | claude-3-7-sonnet | DeepSeek V3 0324 | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | DeepSeek V3 0324 | ? Insufficient evidence | No |
| Reasoner | o3-mini | DeepSeek V3 0324 | ? Insufficient evidence | No |
| Analyst / Researcher | claude-3-7-sonnet | DeepSeek V3 0324 | ? Insufficient evidence | No |
| Agent / Computer-use | claude-3-7-sonnet | DeepSeek V3 0324 | ? Insufficient evidence | No |
| Multimodal | gemini-2.5-pro | DeepSeek V3 0324 | ↘ Probably worse | No |
...
- **Coder / Builder (claude-3-7-sonnet)**: Challenger shows no meaningful capability edge over claude-3-7-sonnet (delta: -33.2% resolved).
...
- **Multimodal (gemini-2.5-pro)**: Challenger shows no meaningful capability edge over gemini-2.5-pro (delta: -7.6%).
...
- **Source:** SWE-bench | **Benchmark:** SWE-bench Verified (verified-v1)
  - **Score:** Challenger: 42.0% resolved vs Incumbent: 75.2% resolved
  - **Harness:** SWE-Exp
  - **URL:** https://www.swebench.com
  - **Confidence:** 75%
  - **Uncertainty:** Different harness: challenger on SWE-Exp, incumbent on TRAE

- **Source:** LMMs-Eval | **Benchmark:** MMMU (Multimodal Benchmark) (val-v1.0)
  - **Score:** Challenger: 65.2% vs Incumbent: 72.8%
