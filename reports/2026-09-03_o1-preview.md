...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | o1-preview | ↘ Probably worse | No |
| Planner | claude-3-7-sonnet | o1-preview | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | o1-preview | ? Insufficient evidence | No |
| Reasoner | o3-mini | o1-preview | ? Insufficient evidence | No |
| Analyst / Researcher | claude-3-7-sonnet | o1-preview | ? Insufficient evidence | No |
| Agent / Computer-use | claude-3-7-sonnet | o1-preview | ? Insufficient evidence | No |
| Multimodal | gemini-2.5-pro | o1-preview | ? Insufficient evidence | No |
...
- **Coder / Builder (claude-3-7-sonnet)**: Challenger shows no meaningful capability edge over claude-3-7-sonnet (delta: -10.6% resolved).
...
- **Source:** SWE-bench | **Benchmark:** SWE-bench Verified (verified-v1)
  - **Score:** Challenger: 64.6% resolved vs Incumbent: 75.2% resolved
  - **Harness:** W&B Programmer O1 crosscheck5
  - **URL:** https://www.swebench.com
  - **Confidence:** 75%
  - **Uncertainty:** Different harness: challenger on W&B Programmer O1 crosscheck5, incumbent on TRAE
