...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | Claude Sonnet 4.5 | = No meaningful advantage | No |
| Planner | claude-3-7-sonnet | Claude Sonnet 4.5 | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | Claude Sonnet 4.5 | ? Insufficient evidence | No |
| Reasoner | o3-mini | Claude Sonnet 4.5 | ? Insufficient evidence | No |
| Analyst / Researcher | claude-3-7-sonnet | Claude Sonnet 4.5 | ? Insufficient evidence | No |
| Agent / Computer-use | claude-3-7-sonnet | Claude Sonnet 4.5 | = No meaningful advantage | No |
| Multimodal | gemini-2.5-pro | Claude Sonnet 4.5 | ? Insufficient evidence | No |
...
- **Coder / Builder (claude-3-7-sonnet)**: Challenger shows no meaningful capability edge over claude-3-7-sonnet (delta: -0.4% resolved).
...
- **Source:** SWE-bench | **Benchmark:** SWE-bench Verified (verified-v1)
  - **Score:** Challenger: 74.8% resolved vs Incumbent: 75.2% resolved
  - **Harness:** Harness AI
  - **URL:** https://www.swebench.com
  - **Confidence:** 75%
  - **Uncertainty:** Different harness: challenger on Harness AI, incumbent on TRAE

- **Source:** Harbor Hub | **Benchmark:** Terminal-Bench 2.0 (v2)
  - **Score:** Challenger: 50.11%
  - **Harness:** Warp
