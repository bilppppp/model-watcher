...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | smaug-agentic | ↗ Probably better | No |
| Planner | claude-3-7-sonnet | smaug-agentic | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | smaug-agentic | ? Insufficient evidence | No |
| Reasoner | o3-mini | smaug-agentic | ↗ Probably better | No |
| Analyst / Researcher | claude-3-7-sonnet | smaug-agentic | = No meaningful advantage | No |
| Agent / Computer-use | claude-3-7-sonnet | smaug-agentic | = No meaningful advantage | No |
| Multimodal | gemini-2.5-pro | smaug-agentic | ? Insufficient evidence | No |
...
- **Coder / Builder (claude-3-7-sonnet)**: Challenger achieved strong score (82.47%), but incumbent baseline score is unverified on same benchmark.
...
- **Reasoner (o3-mini)**: Challenger achieved strong score (90.27%), but incumbent baseline score is unverified on same benchmark.
