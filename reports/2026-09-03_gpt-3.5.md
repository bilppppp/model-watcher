...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | GPT-3.5 | ↘ Probably worse | No |
| Planner | claude-3-7-sonnet | GPT-3.5 | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | GPT-3.5 | ? Insufficient evidence | No |
| Reasoner | o3-mini | GPT-3.5 | ? Insufficient evidence | No |
| Analyst / Researcher | claude-3-7-sonnet | GPT-3.5 | ? Insufficient evidence | No |
| Agent / Computer-use | claude-3-7-sonnet | GPT-3.5 | = No meaningful advantage | No |
| Multimodal | gemini-2.5-pro | GPT-3.5 | ? Insufficient evidence | No |
