...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | O3 Mini | ↘ Probably worse | No |
| Planner | claude-3-7-sonnet | O3 Mini | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | O3 Mini | ? Insufficient evidence | No |
| Reasoner | o3-mini | O3 Mini | ? Insufficient evidence | No |
| Analyst / Researcher | claude-3-7-sonnet | O3 Mini | ? Insufficient evidence | No |
| Agent / Computer-use | claude-3-7-sonnet | O3 Mini | ? Insufficient evidence | No |
| Multimodal | gemini-2.5-pro | O3 Mini | ? Insufficient evidence | No |
...
- **Source:** SWE-bench | **Benchmark:** SWE-bench Verified (verified-v1)
  ...
  - **Harness:** Nemotron-CORTEXA
  - **URL:** https://www.swebench.com
  - **Confidence:** 75%
  - **Uncertainty:** Different harness: challenger on Nemotron-CORTEXA, incumbent on TRAE
