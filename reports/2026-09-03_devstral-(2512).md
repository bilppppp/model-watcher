...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | Devstral (2512) | ↘ Probably worse | No |
| Planner | claude-3-7-sonnet | Devstral (2512) | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | Devstral (2512) | ? Insufficient evidence | No |
| Reasoner | o3-mini | Devstral (2512) | ? Insufficient evidence | No |
| Analyst / Researcher | claude-3-7-sonnet | Devstral (2512) | ? Insufficient evidence | No |
| Agent / Computer-use | claude-3-7-sonnet | Devstral (2512) | ? Insufficient evidence | No |
| Multimodal | gemini-2.5-pro | Devstral (2512) | ? Insufficient evidence | No |
...
- **Coder / Builder (claude-3-7-sonnet)**: Challenger shows no meaningful capability edge over claude-3-7-sonnet (delta: -21.4% resolved).
...
- **Source:** SWE-bench | **Benchmark:** SWE-bench Verified (verified-v1)
  - **Score:** Challenger: 53.8% resolved vs Incumbent: 75.2% resolved
