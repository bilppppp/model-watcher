...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | SWE-Llama 7B | ↘ Probably worse | No |
| Planner | claude-3-7-sonnet | SWE-Llama 7B | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | SWE-Llama 7B | ? Insufficient evidence | No |
| Reasoner | o3-mini | SWE-Llama 7B | ? Insufficient evidence | No |
| Analyst / Researcher | claude-3-7-sonnet | SWE-Llama 7B | ? Insufficient evidence | No |
| Agent / Computer-use | claude-3-7-sonnet | SWE-Llama 7B | ? Insufficient evidence | No |
| Multimodal | gemini-2.5-pro | SWE-Llama 7B | ? Insufficient evidence | No |
...
- **Coder / Builder (claude-3-7-sonnet)**: Challenger shows no meaningful capability edge over claude-3-7-sonnet (delta: -73.8% resolved).
...
- **Source:** SWE-bench | **Benchmark:** SWE-bench Verified (verified-v1)
  - **Score:** Challenger: 1.4% resolved vs Incumbent: 75.2% resolved
