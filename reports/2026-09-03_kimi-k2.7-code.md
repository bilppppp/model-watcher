...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | kimi-k2.7-code | = No meaningful advantage | No |
| Planner | claude-3-7-sonnet | kimi-k2.7-code | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | kimi-k2.7-code | ? Insufficient evidence | No |
| Reasoner | o3-mini | kimi-k2.7-code | ↗ Probably better | No |
| Analyst / Researcher | claude-3-7-sonnet | kimi-k2.7-code | = No meaningful advantage | No |
| Agent / Computer-use | claude-3-7-sonnet | kimi-k2.7-code | = No meaningful advantage | No |
| Multimodal | gemini-2.5-pro | kimi-k2.7-code | ? Insufficient evidence | No |
...
- **Reasoner (o3-mini)**: Challenger achieved strong score (82.81%), but incumbent baseline score is unverified on same benchmark.
