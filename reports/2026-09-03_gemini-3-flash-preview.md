...
| Reasoner | o3-mini | Multiple | ? Insufficient evidence | No |
| Analyst / Researcher | claude-3-7-sonnet | Multiple | ? Insufficient evidence | No |
| Agent / Computer-use | claude-3-7-sonnet | Multiple | = No meaningful advantage | No |
| Multimodal | gemini-2.5-pro | Multiple | ? Insufficient evidence | No |
