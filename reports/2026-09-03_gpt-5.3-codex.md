...
| Agent / Computer-use | claude-3-7-sonnet | Multiple | ↗ Probably better | No |
...
- **Coder / Builder (claude-3-7-sonnet)**: Challenger shows no meaningful capability edge over claude-3-7-sonnet (delta: -0.8% resolved).
...
- **Agent / Computer-use (claude-3-7-sonnet)**: Challenger achieved strong score (84.49%), but incumbent baseline score is unverified on same benchmark.
...
- **Source:** SWE-bench | **Benchmark:** SWE-bench Verified (verified-v1)
  - **Score:** Challenger: 74.4% resolved vs Incumbent: 75.2% resolved
  - **Harness:** Prometheus-v1.2.1
  - **URL:** https://www.swebench.com
  - **Confidence:** 75%
  - **Uncertainty:** Different harness: challenger on Prometheus-v1.2.1, incumbent on TRAE

- **Source:** Harbor Hub | **Benchmark:** Terminal-Bench 2.0 (v2)
  - **Score:** Challenger: 84.49%
