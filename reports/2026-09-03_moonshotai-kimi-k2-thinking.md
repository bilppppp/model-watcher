...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | Kimi K2 Thinking | ↘ Probably worse | No |
| Planner | claude-3-7-sonnet | Kimi K2 Thinking | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | Kimi K2 Thinking | ? Insufficient evidence | No |
| Reasoner | o3-mini | Kimi K2 Thinking | ? Insufficient evidence | No |
| Analyst / Researcher | claude-3-7-sonnet | Kimi K2 Thinking | ? Insufficient evidence | No |
| Agent / Computer-use | claude-3-7-sonnet | Kimi K2 Thinking | = No meaningful advantage | No |
| Multimodal | gemini-2.5-pro | Kimi K2 Thinking | ? Insufficient evidence | No |
...
- **Source:** SWE-bench | **Benchmark:** SWE-bench Verified (verified-v1)
  ...
  - **Confidence:** 75%
  - **Uncertainty:** Different harness: challenger on Lingxi v1.5, incumbent on TRAE

- **Source:** Harbor Hub | **Benchmark:** Terminal-Bench 2.0 (v2)
  - **Score:** Challenger: 35.73%
  - **Harness:** Terminus 2
