...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | Lingma SWE-GPT 72b (v0925) | ↘ Probably worse | No |
| Planner | claude-3-7-sonnet | Lingma SWE-GPT 72b (v0925) | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | Lingma SWE-GPT 72b (v0925) | ? Insufficient evidence | No |
| Reasoner | o3-mini | Lingma SWE-GPT 72b (v0925) | ? Insufficient evidence | No |
| Analyst / Researcher | claude-3-7-sonnet | Lingma SWE-GPT 72b (v0925) | ? Insufficient evidence | No |
| Agent / Computer-use | claude-3-7-sonnet | Lingma SWE-GPT 72b (v0925) | ? Insufficient evidence | No |
| Multimodal | gemini-2.5-pro | Lingma SWE-GPT 72b (v0925) | ? Insufficient evidence | No |
...
- **Coder / Builder (claude-3-7-sonnet)**: Challenger shows no meaningful capability edge over claude-3-7-sonnet (delta: -46.4% resolved).
...
- **Source:** SWE-bench | **Benchmark:** SWE-bench Verified (verified-v1)
  - **Score:** Challenger: 28.8% resolved vs Incumbent: 75.2% resolved
