...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | GPT 4.1 | = No meaningful advantage | No |
| Planner | claude-3-7-sonnet | GPT 4.1 | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | GPT 4.1 | ? Insufficient evidence | No |
| Reasoner | o3-mini | GPT 4.1 | ? Insufficient evidence | No |
| Analyst / Researcher | claude-3-7-sonnet | GPT 4.1 | ? Insufficient evidence | No |
| Agent / Computer-use | claude-3-7-sonnet | GPT 4.1 | ? Insufficient evidence | No |
| Multimodal | gemini-2.5-pro | GPT 4.1 | ? Insufficient evidence | No |
...
- **Source:** SWE-bench | **Benchmark:** SWE-bench Verified (verified-v1)
  - **Score:** Challenger: 74.6% resolved vs Incumbent: 75.2% resolved
  - **Harness:** JoyCode
  - **URL:** https://www.swebench.com
  - **Confidence:** 75%
  - **Uncertainty:** Different harness: challenger on JoyCode, incumbent on TRAE
