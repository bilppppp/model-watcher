...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | MiniMax M2.1 | ↘ Probably worse | No |
| Planner | claude-3-7-sonnet | MiniMax M2.1 | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | MiniMax M2.1 | ? Insufficient evidence | No |
| Reasoner | o3-mini | MiniMax M2.1 | ? Insufficient evidence | No |
| Analyst / Researcher | claude-3-7-sonnet | MiniMax M2.1 | ? Insufficient evidence | No |
| Agent / Computer-use | claude-3-7-sonnet | MiniMax M2.1 | = No meaningful advantage | No |
| Multimodal | gemini-2.5-pro | MiniMax M2.1 | ? Insufficient evidence | No |
