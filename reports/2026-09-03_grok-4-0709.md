...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | Grok 4 | ? Insufficient evidence | No |
| Planner | claude-3-7-sonnet | Grok 4 | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | Grok 4 | ? Insufficient evidence | No |
| Reasoner | o3-mini | Grok 4 | ? Insufficient evidence | No |
| Analyst / Researcher | claude-3-7-sonnet | Grok 4 | ? Insufficient evidence | No |
| Agent / Computer-use | claude-3-7-sonnet | Grok 4 | = No meaningful advantage | No |
| Multimodal | gemini-2.5-pro | Grok 4 | ? Insufficient evidence | No |
