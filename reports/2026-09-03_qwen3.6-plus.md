...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | qwen3.6-plus | = No meaningful advantage | No |
| Planner | claude-3-7-sonnet | qwen3.6-plus | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | qwen3.6-plus | ? Insufficient evidence | No |
| Reasoner | o3-mini | qwen3.6-plus | = No meaningful advantage | No |
| Analyst / Researcher | claude-3-7-sonnet | qwen3.6-plus | = No meaningful advantage | No |
| Agent / Computer-use | claude-3-7-sonnet | qwen3.6-plus | = No meaningful advantage | No |
| Multimodal | gemini-2.5-pro | qwen3.6-plus | ? Insufficient evidence | No |
