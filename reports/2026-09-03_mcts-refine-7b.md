...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | MCTS Refine 7B | ↘ Probably worse | No |
| Planner | claude-3-7-sonnet | MCTS Refine 7B | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | MCTS Refine 7B | ? Insufficient evidence | No |
| Reasoner | o3-mini | MCTS Refine 7B | ? Insufficient evidence | No |
| Analyst / Researcher | claude-3-7-sonnet | MCTS Refine 7B | ? Insufficient evidence | No |
| Agent / Computer-use | claude-3-7-sonnet | MCTS Refine 7B | ? Insufficient evidence | No |
| Multimodal | gemini-2.5-pro | MCTS Refine 7B | ? Insufficient evidence | No |
...
- **Coder / Builder (claude-3-7-sonnet)**: Challenger shows no meaningful capability edge over claude-3-7-sonnet (delta: -52.0% resolved).
...
- **Source:** SWE-bench | **Benchmark:** SWE-bench Verified (verified-v1)
  - **Score:** Challenger: 23.2% resolved vs Incumbent: 75.2% resolved
  - **Harness:** MCTS-Refine-7B
  - **URL:** https://www.swebench.com
  - **Confidence:** 75%
  - **Uncertainty:** Different harness: challenger on MCTS-Refine-7B, incumbent on TRAE
