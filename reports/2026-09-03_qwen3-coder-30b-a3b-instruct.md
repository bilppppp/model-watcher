...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | Qwen3-Coder-30B-A3B-Instruct | ↘ Probably worse | No |
| Planner | claude-3-7-sonnet | Qwen3-Coder-30B-A3B-Instruct | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | Qwen3-Coder-30B-A3B-Instruct | ? Insufficient evidence | No |
| Reasoner | o3-mini | Qwen3-Coder-30B-A3B-Instruct | ? Insufficient evidence | No |
| Analyst / Researcher | claude-3-7-sonnet | Qwen3-Coder-30B-A3B-Instruct | ? Insufficient evidence | No |
| Agent / Computer-use | claude-3-7-sonnet | Qwen3-Coder-30B-A3B-Instruct | ? Insufficient evidence | No |
| Multimodal | gemini-2.5-pro | Qwen3-Coder-30B-A3B-Instruct | ? Insufficient evidence | No |
...
- **Coder / Builder (claude-3-7-sonnet)**: Challenger shows no meaningful capability edge over claude-3-7-sonnet (delta: -14.8% resolved).
...
- **Source:** SWE-bench | **Benchmark:** SWE-bench Verified (verified-v1)
  - **Score:** Challenger: 60.4% resolved vs Incumbent: 75.2% resolved
  - **Harness:** EntroPO + R2E
  - **URL:** https://www.swebench.com
  - **Confidence:** 75%
  - **Uncertainty:** Different harness: challenger on EntroPO + R2E, incumbent on TRAE
