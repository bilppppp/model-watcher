...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | deepseek-v4-pro | = No meaningful advantage | No |
| Planner | claude-3-7-sonnet | deepseek-v4-pro | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | deepseek-v4-pro | ? Insufficient evidence | No |
| Reasoner | o3-mini | deepseek-v4-pro | ↗ Probably better | No |
| Analyst / Researcher | claude-3-7-sonnet | deepseek-v4-pro | = No meaningful advantage | No |
| Agent / Computer-use | claude-3-7-sonnet | deepseek-v4-pro | = No meaningful advantage | No |
| Multimodal | gemini-2.5-pro | deepseek-v4-pro | ? Insufficient evidence | No |
...
- **Reasoner (o3-mini)**: Challenger achieved strong score (82.69%), but incumbent baseline score is unverified on same benchmark.
