...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | gpt-5.6-luna-max | ↗ Probably better | No |
| Planner | claude-3-7-sonnet | gpt-5.6-luna-max | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | gpt-5.6-luna-max | ? Insufficient evidence | No |
| Reasoner | o3-mini | gpt-5.6-luna-max | ↗ Probably better | No |
| Analyst / Researcher | claude-3-7-sonnet | gpt-5.6-luna-max | = No meaningful advantage | No |
| Agent / Computer-use | claude-3-7-sonnet | gpt-5.6-luna-max | = No meaningful advantage | No |
| Multimodal | gemini-2.5-pro | gpt-5.6-luna-max | ? Insufficient evidence | No |
...
- **Coder / Builder (claude-3-7-sonnet)**: Challenger achieved strong score (82.91%), but incumbent baseline score is unverified on same benchmark.
...
- **Reasoner (o3-mini)**: Challenger achieved strong score (85.64%), but incumbent baseline score is unverified on same benchmark.
