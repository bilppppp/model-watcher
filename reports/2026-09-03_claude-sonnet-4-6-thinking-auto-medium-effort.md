...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | claude-sonnet-4-6-thinking-auto-medium-effort | = No meaningful advantage | No |
| Planner | claude-3-7-sonnet | claude-sonnet-4-6-thinking-auto-medium-effort | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | claude-sonnet-4-6-thinking-auto-medium-effort | ? Insufficient evidence | No |
| Reasoner | o3-mini | claude-sonnet-4-6-thinking-auto-medium-effort | ↗ Probably better | No |
| Analyst / Researcher | claude-3-7-sonnet | claude-sonnet-4-6-thinking-auto-medium-effort | = No meaningful advantage | No |
| Agent / Computer-use | claude-3-7-sonnet | claude-sonnet-4-6-thinking-auto-medium-effort | = No meaningful advantage | No |
| Multimodal | gemini-2.5-pro | claude-sonnet-4-6-thinking-auto-medium-effort | ? Insufficient evidence | No |
...
- **Reasoner (o3-mini)**: Challenger achieved strong score (84.77%), but incumbent baseline score is unverified on same benchmark.
