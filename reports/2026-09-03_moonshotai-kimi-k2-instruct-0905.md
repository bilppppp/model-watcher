...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | Kimi K2 Instruct | ↘ Probably worse | No |
| Planner | claude-3-7-sonnet | Kimi K2 Instruct | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | Kimi K2 Instruct | ? Insufficient evidence | No |
| Reasoner | o3-mini | Kimi K2 Instruct | ? Insufficient evidence | No |
| Analyst / Researcher | claude-3-7-sonnet | Kimi K2 Instruct | ? Insufficient evidence | No |
| Agent / Computer-use | claude-3-7-sonnet | Kimi K2 Instruct | = No meaningful advantage | No |
| Multimodal | gemini-2.5-pro | Kimi K2 Instruct | ? Insufficient evidence | No |
