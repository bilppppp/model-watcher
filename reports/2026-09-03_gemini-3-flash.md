...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | Gemini 3 Flash | = No meaningful advantage | No |
| Planner | claude-3-7-sonnet | Gemini 3 Flash | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | Gemini 3 Flash | ? Insufficient evidence | No |
| Reasoner | o3-mini | Gemini 3 Flash | ? Insufficient evidence | No |
| Analyst / Researcher | claude-3-7-sonnet | Gemini 3 Flash | ? Insufficient evidence | No |
| Agent / Computer-use | claude-3-7-sonnet | Gemini 3 Flash | = No meaningful advantage | No |
| Multimodal | gemini-2.5-pro | Gemini 3 Flash | ? Insufficient evidence | No |
...
- **Coder / Builder (claude-3-7-sonnet)**: Challenger shows no meaningful capability edge over claude-3-7-sonnet (delta: +0.6% resolved).
...
- **Source:** SWE-bench | **Benchmark:** SWE-bench Verified (verified-v1)
  - **Score:** Challenger: 75.8% resolved vs Incumbent: 75.2% resolved
