...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | DeepSeek V3.2 Reasoner | ↘ Probably worse | No |
| Planner | claude-3-7-sonnet | DeepSeek V3.2 Reasoner | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | DeepSeek V3.2 Reasoner | ? Insufficient evidence | No |
| Reasoner | o3-mini | DeepSeek V3.2 Reasoner | ? Insufficient evidence | No |
| Analyst / Researcher | claude-3-7-sonnet | DeepSeek V3.2 Reasoner | ? Insufficient evidence | No |
| Agent / Computer-use | claude-3-7-sonnet | DeepSeek V3.2 Reasoner | ? Insufficient evidence | No |
| Multimodal | gemini-2.5-pro | DeepSeek V3.2 Reasoner | ↘ Probably worse | No |
...
- **Coder / Builder (claude-3-7-sonnet)**: Challenger shows no meaningful capability edge over claude-3-7-sonnet (delta: -5.2% resolved).
...
- **Source:** SWE-bench | **Benchmark:** SWE-bench Verified (verified-v1)
  - **Score:** Challenger: 70.0% resolved vs Incumbent: 75.2% resolved
