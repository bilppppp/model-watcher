...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | claude-opus-4-8-max-effort | ↗ Probably better | No |
| Planner | claude-3-7-sonnet | claude-opus-4-8-max-effort | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | claude-opus-4-8-max-effort | ? Insufficient evidence | No |
| Reasoner | o3-mini | claude-opus-4-8-max-effort | ↗ Probably better | No |
| Analyst / Researcher | claude-3-7-sonnet | claude-opus-4-8-max-effort | = No meaningful advantage | No |
| Agent / Computer-use | claude-3-7-sonnet | claude-opus-4-8-max-effort | = No meaningful advantage | No |
| Multimodal | gemini-2.5-pro | claude-opus-4-8-max-effort | ? Insufficient evidence | No |
...
- **Coder / Builder (claude-3-7-sonnet)**: Challenger achieved strong score (81.83%), but incumbent baseline score is unverified on same benchmark.
...
- **Reasoner (o3-mini)**: Challenger achieved strong score (89.19%), but incumbent baseline score is unverified on same benchmark.
