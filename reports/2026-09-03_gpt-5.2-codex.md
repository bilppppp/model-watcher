...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | gpt-5.2-codex | ↗ Probably better | No |
| Planner | claude-3-7-sonnet | gpt-5.2-codex | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | gpt-5.2-codex | ? Insufficient evidence | No |
| Reasoner | o3-mini | gpt-5.2-codex | = No meaningful advantage | No |
| Analyst / Researcher | claude-3-7-sonnet | gpt-5.2-codex | = No meaningful advantage | No |
| Agent / Computer-use | claude-3-7-sonnet | gpt-5.2-codex | = No meaningful advantage | No |
| Multimodal | gemini-2.5-pro | gpt-5.2-codex | ? Insufficient evidence | No |
