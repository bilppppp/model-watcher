# 🆕 CodeAct v2.1 (claude-3-5-sonnet-20241022)
...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | CodeAct v2.1 (claude-3-5-sonnet-20241022) | ↘ Probably worse | No |
| Planner | claude-3-7-sonnet | CodeAct v2.1 (claude-3-5-sonnet-20241022) | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | CodeAct v2.1 (claude-3-5-sonnet-20241022) | ? Insufficient evidence | No |
| Reasoner | o3-mini | CodeAct v2.1 (claude-3-5-sonnet-20241022) | ? Insufficient evidence | No |
| Analyst / Researcher | claude-3-7-sonnet | CodeAct v2.1 (claude-3-5-sonnet-20241022) | ? Insufficient evidence | No |
| Agent / Computer-use | claude-3-7-sonnet | CodeAct v2.1 (claude-3-5-sonnet-20241022) | ? Insufficient evidence | No |
| Multimodal | gemini-2.5-pro | CodeAct v2.1 (claude-3-5-sonnet-20241022) | ? Insufficient evidence | No |
...
- **Coder / Builder (claude-3-7-sonnet)**: Challenger shows no meaningful capability edge over claude-3-7-sonnet (delta: -11.8% resolved).
...
- **Source:** SWE-bench | **Benchmark:** SWE-bench Verified (verified-v1)
  - **Score:** Challenger: 63.4% resolved vs Incumbent: 75.2% resolved
  - **Harness:** AgentScope
  - **URL:** https://www.swebench.com
  - **Confidence:** 75%
  - **Uncertainty:** Different harness: challenger on AgentScope, incumbent on TRAE
