...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | Multiple | ↘ Probably worse | No |
...
- **Coder / Builder (claude-3-7-sonnet)**: Challenger shows no meaningful capability edge over claude-3-7-sonnet (delta: -8.6% resolved).
...
- **Source:** SWE-bench | **Benchmark:** SWE-bench Verified (verified-v1)
  - **Score:** Challenger: 66.6% resolved vs Incumbent: 75.2% resolved
