...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | AfterQuery-GPT-OSS-20B | ? Insufficient evidence | No |
| Planner | claude-3-7-sonnet | AfterQuery-GPT-OSS-20B | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | AfterQuery-GPT-OSS-20B | ? Insufficient evidence | No |
| Reasoner | o3-mini | AfterQuery-GPT-OSS-20B | ? Insufficient evidence | No |
| Analyst / Researcher | claude-3-7-sonnet | AfterQuery-GPT-OSS-20B | ? Insufficient evidence | No |
| Agent / Computer-use | claude-3-7-sonnet | AfterQuery-GPT-OSS-20B | = No meaningful advantage | No |
| Multimodal | gemini-2.5-pro | AfterQuery-GPT-OSS-20B | ? Insufficient evidence | No |
