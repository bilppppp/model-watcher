...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | DeepSeek V3.2 | ↘ Probably worse | No |
| Planner | claude-3-7-sonnet | DeepSeek V3.2 | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | DeepSeek V3.2 | ? Insufficient evidence | No |
| Reasoner | o3-mini | DeepSeek V3.2 | ? Insufficient evidence | No |
| Analyst / Researcher | claude-3-7-sonnet | DeepSeek V3.2 | ? Insufficient evidence | No |
| Agent / Computer-use | claude-3-7-sonnet | DeepSeek V3.2 | = No meaningful advantage | No |
| Multimodal | gemini-2.5-pro | DeepSeek V3.2 | ↘ Probably worse | No |
