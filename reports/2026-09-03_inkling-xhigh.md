...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | inkling-xhigh | = No meaningful advantage | No |
| Planner | claude-3-7-sonnet | inkling-xhigh | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | inkling-xhigh | ? Insufficient evidence | No |
| Reasoner | o3-mini | inkling-xhigh | = No meaningful advantage | No |
| Analyst / Researcher | claude-3-7-sonnet | inkling-xhigh | = No meaningful advantage | No |
| Agent / Computer-use | claude-3-7-sonnet | inkling-xhigh | = No meaningful advantage | No |
| Multimodal | gemini-2.5-pro | inkling-xhigh | ? Insufficient evidence | No |
