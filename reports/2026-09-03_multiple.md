...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | Multiple | ↗ Probably better | No |
...
- **Coder / Builder (claude-3-7-sonnet)**: Advantage of +1.6% resolved may be artifact of test harness (Different harness: challenger on Atlassian Rovo Dev, incumbent on TRAE). Not worth switching risk.
...
- **Source:** SWE-bench | **Benchmark:** SWE-bench Verified (verified-v1)
  ...
  - **Harness:** Atlassian Rovo Dev
  - **URL:** https://www.swebench.com
  - **Confidence:** 75%
  - **Uncertainty:** Different harness: challenger on Atlassian Rovo Dev, incumbent on TRAE
