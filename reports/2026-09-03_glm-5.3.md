...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | glm-5.3 | = No meaningful advantage | No |
| Planner | claude-3-7-sonnet | glm-5.3 | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | glm-5.3 | ? Insufficient evidence | No |
| Reasoner | o3-mini | glm-5.3 | ↗ Probably better | No |
| Analyst / Researcher | claude-3-7-sonnet | glm-5.3 | = No meaningful advantage | No |
| Agent / Computer-use | claude-3-7-sonnet | glm-5.3 | = No meaningful advantage | No |
| Multimodal | gemini-2.5-pro | glm-5.3 | ? Insufficient evidence | No |
...
- **Reasoner (o3-mini)**: Challenger achieved strong score (85.8%), but incumbent baseline score is unverified on same benchmark.
