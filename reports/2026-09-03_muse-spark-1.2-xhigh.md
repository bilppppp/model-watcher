...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | muse-spark-1.2-xhigh | = No meaningful advantage | No |
| Planner | claude-3-7-sonnet | muse-spark-1.2-xhigh | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | muse-spark-1.2-xhigh | ? Insufficient evidence | No |
| Reasoner | o3-mini | muse-spark-1.2-xhigh | ↗ Probably better | No |
| Analyst / Researcher | claude-3-7-sonnet | muse-spark-1.2-xhigh | = No meaningful advantage | No |
| Agent / Computer-use | claude-3-7-sonnet | muse-spark-1.2-xhigh | = No meaningful advantage | No |
| Multimodal | gemini-2.5-pro | muse-spark-1.2-xhigh | ? Insufficient evidence | No |
...
- **Reasoner (o3-mini)**: Challenger achieved strong score (90.0%), but incumbent baseline score is unverified on same benchmark.
