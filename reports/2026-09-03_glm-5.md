...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | GLM 5 | = No meaningful advantage | No |
| Planner | claude-3-7-sonnet | GLM 5 | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | GLM 5 | ? Insufficient evidence | No |
| Reasoner | o3-mini | GLM 5 | = No meaningful advantage | No |
| Analyst / Researcher | claude-3-7-sonnet | GLM 5 | = No meaningful advantage | No |
| Agent / Computer-use | claude-3-7-sonnet | GLM 5 | = No meaningful advantage | No |
| Multimodal | gemini-2.5-pro | GLM 5 | ? Insufficient evidence | No |
