...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | claude-fable-5-1-max-effort | ↗ Probably better | No |
| Planner | claude-3-7-sonnet | claude-fable-5-1-max-effort | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | claude-fable-5-1-max-effort | ? Insufficient evidence | No |
| Reasoner | o3-mini | claude-fable-5-1-max-effort | ↗ Probably better | No |
| Analyst / Researcher | claude-3-7-sonnet | claude-fable-5-1-max-effort | ↗ Probably better | No |
| Agent / Computer-use | claude-3-7-sonnet | claude-fable-5-1-max-effort | = No meaningful advantage | No |
| Multimodal | gemini-2.5-pro | claude-fable-5-1-max-effort | ? Insufficient evidence | No |
...
- **Coder / Builder (claude-3-7-sonnet)**: Challenger achieved strong score (86.38%), but incumbent baseline score is unverified on same benchmark.
...
- **Reasoner (o3-mini)**: Challenger achieved strong score (91.69%), but incumbent baseline score is unverified on same benchmark.
- **Analyst / Researcher (claude-3-7-sonnet)**: Challenger achieved strong score (80.28%), but incumbent baseline score is unverified on same benchmark.
