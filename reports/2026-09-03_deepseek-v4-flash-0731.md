...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | deepseek-v4-flash-0731 | = No meaningful advantage | No |
| Planner | claude-3-7-sonnet | deepseek-v4-flash-0731 | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | deepseek-v4-flash-0731 | ? Insufficient evidence | No |
| Reasoner | o3-mini | deepseek-v4-flash-0731 | ↗ Probably better | No |
| Analyst / Researcher | claude-3-7-sonnet | deepseek-v4-flash-0731 | = No meaningful advantage | No |
| Agent / Computer-use | claude-3-7-sonnet | deepseek-v4-flash-0731 | = No meaningful advantage | No |
| Multimodal | gemini-2.5-pro | deepseek-v4-flash-0731 | ? Insufficient evidence | No |
...
- **Reasoner (o3-mini)**: Challenger achieved strong score (86.63%), but incumbent baseline score is unverified on same benchmark.
