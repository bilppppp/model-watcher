...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | swe-search | ↘ Probably worse | No |
| Planner | claude-3-7-sonnet | swe-search | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | swe-search | ? Insufficient evidence | No |
| Reasoner | o3-mini | swe-search | ? Insufficient evidence | No |
| Analyst / Researcher | claude-3-7-sonnet | swe-search | ? Insufficient evidence | No |
| Agent / Computer-use | claude-3-7-sonnet | swe-search | ? Insufficient evidence | No |
| Multimodal | gemini-2.5-pro | swe-search | ? Insufficient evidence | No |
...
- **Coder / Builder (claude-3-7-sonnet)**: Challenger shows no meaningful capability edge over claude-3-7-sonnet (delta: -13.0% resolved).
...
- **Source:** SWE-bench | **Benchmark:** SWE-bench Verified (verified-v1)
  - **Score:** Challenger: 62.2% resolved vs Incumbent: 75.2% resolved
  - **Harness:** CodeStory Midwit Agent
  - **URL:** https://www.swebench.com
  - **Confidence:** 75%
  - **Uncertainty:** Different harness: challenger on CodeStory Midwit Agent, incumbent on TRAE
