...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | Llama 4 Scout Instruct | ↘ Probably worse | No |
| Planner | claude-3-7-sonnet | Llama 4 Scout Instruct | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | Llama 4 Scout Instruct | ? Insufficient evidence | No |
| Reasoner | o3-mini | Llama 4 Scout Instruct | ? Insufficient evidence | No |
| Analyst / Researcher | claude-3-7-sonnet | Llama 4 Scout Instruct | ? Insufficient evidence | No |
| Agent / Computer-use | claude-3-7-sonnet | Llama 4 Scout Instruct | ? Insufficient evidence | No |
| Multimodal | gemini-2.5-pro | Llama 4 Scout Instruct | ? Insufficient evidence | No |
...
- **Coder / Builder (claude-3-7-sonnet)**: Challenger shows no meaningful capability edge over claude-3-7-sonnet (delta: -66.1% resolved).
...
- **Source:** SWE-bench | **Benchmark:** SWE-bench Verified (verified-v1)
  - **Score:** Challenger: 9.1% resolved vs Incumbent: 75.2% resolved
