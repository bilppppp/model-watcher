# 🆕 Gemini 2.0 Flash (v20241212-experimental)
...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | Gemini 2.0 Flash (v20241212-experimental) | ↘ Probably worse | No |
| Planner | claude-3-7-sonnet | Gemini 2.0 Flash (v20241212-experimental) | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | Gemini 2.0 Flash (v20241212-experimental) | ? Insufficient evidence | No |
| Reasoner | o3-mini | Gemini 2.0 Flash (v20241212-experimental) | ? Insufficient evidence | No |
| Analyst / Researcher | claude-3-7-sonnet | Gemini 2.0 Flash (v20241212-experimental) | ? Insufficient evidence | No |
| Agent / Computer-use | claude-3-7-sonnet | Gemini 2.0 Flash (v20241212-experimental) | ? Insufficient evidence | No |
| Multimodal | gemini-2.5-pro | Gemini 2.0 Flash (v20241212-experimental) | ? Insufficient evidence | No |
...
- **Coder / Builder (claude-3-7-sonnet)**: Challenger shows no meaningful capability edge over claude-3-7-sonnet (delta: -23.0% resolved).
...
- **Source:** SWE-bench | **Benchmark:** SWE-bench Verified (verified-v1)
  - **Score:** Challenger: 52.2% resolved vs Incumbent: 75.2% resolved
  - **Harness:** Google Jules
  - **URL:** https://www.swebench.com
  - **Confidence:** 75%
  - **Uncertainty:** Different harness: challenger on Google Jules, incumbent on TRAE
