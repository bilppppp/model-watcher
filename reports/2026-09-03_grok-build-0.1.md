...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | grok-build-0.1 | = No meaningful advantage | No |
| Planner | claude-3-7-sonnet | grok-build-0.1 | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | grok-build-0.1 | ? Insufficient evidence | No |
| Reasoner | o3-mini | grok-build-0.1 | = No meaningful advantage | No |
| Analyst / Researcher | claude-3-7-sonnet | grok-build-0.1 | = No meaningful advantage | No |
| Agent / Computer-use | claude-3-7-sonnet | grok-build-0.1 | = No meaningful advantage | No |
| Multimodal | gemini-2.5-pro | grok-build-0.1 | ? Insufficient evidence | No |
