...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | Claude 3.5 Sonnet | ↘ Probably worse | No |
| Planner | claude-3-7-sonnet | Claude 3.5 Sonnet | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | Claude 3.5 Sonnet | ? Insufficient evidence | No |
| Reasoner | o3-mini | Claude 3.5 Sonnet | ? Insufficient evidence | No |
| Analyst / Researcher | claude-3-7-sonnet | Claude 3.5 Sonnet | ? Insufficient evidence | No |
| Agent / Computer-use | claude-3-7-sonnet | Claude 3.5 Sonnet | ? Insufficient evidence | No |
| Multimodal | gemini-2.5-pro | Claude 3.5 Sonnet | ? Insufficient evidence | No |
