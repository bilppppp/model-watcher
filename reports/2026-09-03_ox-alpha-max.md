...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | ox-alpha-max | = No meaningful advantage | No |
| Planner | claude-3-7-sonnet | ox-alpha-max | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | ox-alpha-max | ? Insufficient evidence | No |
| Reasoner | o3-mini | ox-alpha-max | = No meaningful advantage | No |
| Analyst / Researcher | claude-3-7-sonnet | ox-alpha-max | = No meaningful advantage | No |
| Agent / Computer-use | claude-3-7-sonnet | ox-alpha-max | = No meaningful advantage | No |
| Multimodal | gemini-2.5-pro | ox-alpha-max | ? Insufficient evidence | No |
