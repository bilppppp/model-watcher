...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | Llama 4 Maverick Instruct | ↘ Probably worse | No |
| Planner | claude-3-7-sonnet | Llama 4 Maverick Instruct | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | Llama 4 Maverick Instruct | ? Insufficient evidence | No |
| Reasoner | o3-mini | Llama 4 Maverick Instruct | ? Insufficient evidence | No |
| Analyst / Researcher | claude-3-7-sonnet | Llama 4 Maverick Instruct | ? Insufficient evidence | No |
| Agent / Computer-use | claude-3-7-sonnet | Llama 4 Maverick Instruct | ? Insufficient evidence | No |
| Multimodal | gemini-2.5-pro | Llama 4 Maverick Instruct | ? Insufficient evidence | No |
...
- **Coder / Builder (claude-3-7-sonnet)**: Challenger shows no meaningful capability edge over claude-3-7-sonnet (delta: -54.2% resolved).
...
- **Source:** SWE-bench | **Benchmark:** SWE-bench Verified (verified-v1)
  - **Score:** Challenger: 21.0% resolved vs Incumbent: 75.2% resolved
