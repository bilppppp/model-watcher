...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | 4x Scaled | ↘ Probably worse | No |
| Planner | claude-3-7-sonnet | 4x Scaled | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | 4x Scaled | ? Insufficient evidence | No |
| Reasoner | o3-mini | 4x Scaled | ? Insufficient evidence | No |
| Analyst / Researcher | claude-3-7-sonnet | 4x Scaled | ? Insufficient evidence | No |
| Agent / Computer-use | claude-3-7-sonnet | 4x Scaled | ? Insufficient evidence | No |
| Multimodal | gemini-2.5-pro | 4x Scaled | ? Insufficient evidence | No |
...
- **Coder / Builder (claude-3-7-sonnet)**: Challenger shows no meaningful capability edge over claude-3-7-sonnet (delta: -14.4% resolved).
...
- **Source:** SWE-bench | **Benchmark:** SWE-bench Verified (verified-v1)
  - **Score:** Challenger: 60.8% resolved vs Incumbent: 75.2% resolved
  - **Harness:** OpenHands
