...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | GPT-5-Codex | = No meaningful advantage | No |
| Planner | claude-3-7-sonnet | GPT-5-Codex | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | GPT-5-Codex | ? Insufficient evidence | No |
| Reasoner | o3-mini | GPT-5-Codex | ? Insufficient evidence | No |
| Analyst / Researcher | claude-3-7-sonnet | GPT-5-Codex | ? Insufficient evidence | No |
| Agent / Computer-use | claude-3-7-sonnet | GPT-5-Codex | = No meaningful advantage | No |
| Multimodal | gemini-2.5-pro | GPT-5-Codex | ? Insufficient evidence | No |
