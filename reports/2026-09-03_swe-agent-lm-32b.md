...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | SWE-agent-LM-32B | ↘ Probably worse | No |
| Planner | claude-3-7-sonnet | SWE-agent-LM-32B | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | SWE-agent-LM-32B | ? Insufficient evidence | No |
| Reasoner | o3-mini | SWE-agent-LM-32B | ? Insufficient evidence | No |
| Analyst / Researcher | claude-3-7-sonnet | SWE-agent-LM-32B | ? Insufficient evidence | No |
| Agent / Computer-use | claude-3-7-sonnet | SWE-agent-LM-32B | ? Insufficient evidence | No |
| Multimodal | gemini-2.5-pro | SWE-agent-LM-32B | ? Insufficient evidence | No |
...
- **Coder / Builder (claude-3-7-sonnet)**: Challenger shows no meaningful capability edge over claude-3-7-sonnet (delta: -35.0% resolved).
...
- **Source:** SWE-bench | **Benchmark:** SWE-bench Verified (verified-v1)
  - **Score:** Challenger: 40.2% resolved vs Incumbent: 75.2% resolved
  - **Harness:** SWE-agent
