...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | GPT-5.5 | ↗ Probably better | No |
| Planner | claude-3-7-sonnet | GPT-5.5 | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | GPT-5.5 | ? Insufficient evidence | No |
| Reasoner | o3-mini | GPT-5.5 | ↗ Probably better | No |
| Analyst / Researcher | claude-3-7-sonnet | GPT-5.5 | ↗ Probably better | No |
| Agent / Computer-use | claude-3-7-sonnet | GPT-5.5 | = No meaningful advantage | No |
| Multimodal | gemini-2.5-pro | GPT-5.5 | ↗ Probably better | No |
