...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | Co-PatcheR | ↘ Probably worse | No |
| Planner | claude-3-7-sonnet | Co-PatcheR | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | Co-PatcheR | ? Insufficient evidence | No |
| Reasoner | o3-mini | Co-PatcheR | ? Insufficient evidence | No |
| Analyst / Researcher | claude-3-7-sonnet | Co-PatcheR | ? Insufficient evidence | No |
| Agent / Computer-use | claude-3-7-sonnet | Co-PatcheR | ? Insufficient evidence | No |
| Multimodal | gemini-2.5-pro | Co-PatcheR | ? Insufficient evidence | No |
...
- **Coder / Builder (claude-3-7-sonnet)**: Challenger shows no meaningful capability edge over claude-3-7-sonnet (delta: -29.2% resolved).
...
- **Source:** SWE-bench | **Benchmark:** SWE-bench Verified (verified-v1)
  - **Score:** Challenger: 46.0% resolved vs Incumbent: 75.2% resolved
  - **Harness:** PatchPilot
  - **URL:** https://www.swebench.com
  - **Confidence:** 75%
  - **Uncertainty:** Different harness: challenger on PatchPilot, incumbent on TRAE
