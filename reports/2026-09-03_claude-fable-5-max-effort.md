...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | claude-fable-5-max-effort | ↗ Probably better | No |
| Planner | claude-3-7-sonnet | claude-fable-5-max-effort | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | claude-fable-5-max-effort | ? Insufficient evidence | No |
| Reasoner | o3-mini | claude-fable-5-max-effort | ↗ Probably better | No |
| Analyst / Researcher | claude-3-7-sonnet | claude-fable-5-max-effort | ↗ Probably better | No |
| Agent / Computer-use | claude-3-7-sonnet | claude-fable-5-max-effort | = No meaningful advantage | No |
| Multimodal | gemini-2.5-pro | claude-fable-5-max-effort | ? Insufficient evidence | No |
...
- **Coder / Builder (claude-3-7-sonnet)**: Challenger achieved strong score (85.99%), but incumbent baseline score is unverified on same benchmark.
...
- **Analyst / Researcher (claude-3-7-sonnet)**: Challenger achieved strong score (80.54%), but incumbent baseline score is unverified on same benchmark.
