...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | MiniMax M2.7 | ↘ Probably worse | No |
| Planner | claude-3-7-sonnet | MiniMax M2.7 | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | MiniMax M2.7 | ? Insufficient evidence | No |
| Reasoner | o3-mini | MiniMax M2.7 | ? Insufficient evidence | No |
| Analyst / Researcher | claude-3-7-sonnet | MiniMax M2.7 | ? Insufficient evidence | No |
| Agent / Computer-use | claude-3-7-sonnet | MiniMax M2.7 | = No meaningful advantage | No |
| Multimodal | gemini-2.5-pro | MiniMax M2.7 | ? Insufficient evidence | No |
...
- **Source:** Harbor Hub | **Benchmark:** Terminal-Bench 2.0 (v2)
  - **Score:** Challenger: 45.06%
  - **Harness:** IndusAGI Coding Agent
