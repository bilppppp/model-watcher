...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | muse-spark-1.3-xhigh | ↗ Probably better | No |
| Planner | claude-3-7-sonnet | muse-spark-1.3-xhigh | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | muse-spark-1.3-xhigh | ? Insufficient evidence | No |
| Reasoner | o3-mini | muse-spark-1.3-xhigh | ↗ Probably better | No |
| Analyst / Researcher | claude-3-7-sonnet | muse-spark-1.3-xhigh | = No meaningful advantage | No |
| Agent / Computer-use | claude-3-7-sonnet | muse-spark-1.3-xhigh | = No meaningful advantage | No |
| Multimodal | gemini-2.5-pro | muse-spark-1.3-xhigh | ? Insufficient evidence | No |
...
- **Coder / Builder (claude-3-7-sonnet)**: Challenger achieved strong score (81.06%), but incumbent baseline score is unverified on same benchmark.
