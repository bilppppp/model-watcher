...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | kimi-k3 | ↗ Probably better | No |
| Planner | claude-3-7-sonnet | kimi-k3 | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | kimi-k3 | ? Insufficient evidence | No |
| Reasoner | o3-mini | kimi-k3 | ↗ Probably better | No |
| Analyst / Researcher | claude-3-7-sonnet | kimi-k3 | = No meaningful advantage | No |
| Agent / Computer-use | claude-3-7-sonnet | kimi-k3 | = No meaningful advantage | No |
| Multimodal | gemini-2.5-pro | kimi-k3 | ? Insufficient evidence | No |
...
- **Reasoner (o3-mini)**: Challenger achieved strong score (90.67%), but incumbent baseline score is unverified on same benchmark.
