...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | claude-sonnet-5-xhigh-effort | ↗ Probably better | No |
| Planner | claude-3-7-sonnet | claude-sonnet-5-xhigh-effort | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | claude-sonnet-5-xhigh-effort | ? Insufficient evidence | No |
| Reasoner | o3-mini | claude-sonnet-5-xhigh-effort | ↗ Probably better | No |
| Analyst / Researcher | claude-3-7-sonnet | claude-sonnet-5-xhigh-effort | = No meaningful advantage | No |
| Agent / Computer-use | claude-3-7-sonnet | claude-sonnet-5-xhigh-effort | = No meaningful advantage | No |
| Multimodal | gemini-2.5-pro | claude-sonnet-5-xhigh-effort | ? Insufficient evidence | No |
...
- **Coder / Builder (claude-3-7-sonnet)**: Challenger achieved strong score (80.68%), but incumbent baseline score is unverified on same benchmark.
...
- **Reasoner (o3-mini)**: Challenger achieved strong score (88.69%), but incumbent baseline score is unverified on same benchmark.
