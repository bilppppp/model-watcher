...
|---|---|---|---|---|
| Coder / Builder | claude-3-7-sonnet | gpt-5.4-nano-xhigh | = No meaningful advantage | No |
| Planner | claude-3-7-sonnet | gpt-5.4-nano-xhigh | ? Insufficient evidence | No |
| Reviewer | claude-3-7-sonnet | gpt-5.4-nano-xhigh | ? Insufficient evidence | No |
| Reasoner | o3-mini | gpt-5.4-nano-xhigh | ↗ Probably better | No |
| Analyst / Researcher | claude-3-7-sonnet | gpt-5.4-nano-xhigh | = No meaningful advantage | No |
| Agent / Computer-use | claude-3-7-sonnet | gpt-5.4-nano-xhigh | = No meaningful advantage | No |
| Multimodal | gemini-2.5-pro | gpt-5.4-nano-xhigh | ? Insufficient evidence | No |
...
- **Reasoner (o3-mini)**: Challenger achieved strong score (81.1%), but incumbent baseline score is unverified on same benchmark.
